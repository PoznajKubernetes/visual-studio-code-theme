...
const THEME_YAML_FILE = path.join(__dirname, '..', 'src', 'poznajkubernetes.yml');
...
async function build() {
    ...
    const standardThemePath = path.join(THEME_DIR, 'poznajkubernetes.json');
    const softThemePath = path.join(THEME_DIR, 'poznajkubernetes-soft.json');
